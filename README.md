...
This project is built using [Next.js](https://nextjs.org) and [shadcn/ui](https://ui.shadcn.com). It is based on the installation guide from [shadcn/ui for Next.js](https://ui.shadcn.com/docs/installation/next).
